...
以下のサンプルはそれぞれ異なる原画像を使い、Panel 129 が一枚ずつ独立した一回の生成で作成しました。AIメタデータは削除済みです。横長は左に実写、右にデザインを置く厳密な50:50、縦長は上に実写、下にデザインを置く厳密な50:50です。
...
サンプルには各原写真に即した短い中国語コピーを使い、一部に小さな英語注記を添えています。
