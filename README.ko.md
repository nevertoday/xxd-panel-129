...
아래 샘플은 서로 다른 원본 참고 이미지를 사용했습니다. Panel 129이 각 이미지를 독립적으로 한 번만 생성했으며 AI 메타데이터도 제거했습니다. 가로 샘플은 왼쪽 원본·오른쪽 디자인의 정확한 50:50, 세로 샘플은 위 원본·아래 디자인의 정확한 50:50입니다.
...
샘플은 각 원본 사진에 맞춘 짧은 중국어 문구를 사용하며, 일부에는 작은 영어 주석이 있습니다.
